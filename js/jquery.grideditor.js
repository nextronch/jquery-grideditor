    ...
    $.fn.gridEditor = function( options ) {
        ...
        const plugins = {
            ...
            row:{
                ...
                get:function(type) {
                    if($.fn.gridEditor.rowPlugins[type]==undefined){throw new Error(`unknown Grideditor Row Plugin '${type}'. Include the plugin you require.`)}
                    return $.fn.gridEditor.rowPlugins[type];
                },
                /** get all RowPlugins */
                getAll:function() {
